functions {
  matrix fill_matrix(real absent_nonbasic, real nonbasic_absent, real noIDCC_IDCC, real IDCC_noIDCC, real noIDCC_nonbasic_basic, real noIDCC_basic_nonbasic, real IDCC_nonbasic_basic, real IDCC_basic_nonbasic, int J) {
...
transformed parameters {
  matrix[J,J] Q = fill_matrix(absent_nonbasic, nonbasic_absent, noIDCC_IDCC, IDCC_noIDCC, noIDCC_nonbasic_basic, noIDCC_basic_nonbasic, IDCC_nonbasic_basic, IDCC_basic_nonbasic, J);
