functions {
  matrix fill_matrix(real absent_nonbasic, real nonbasic_absent, real nonbasic_noIDCC_IDCC, real nonbasic_IDCC_noIDCC, real noIDCC_nonbasic_basic, real noIDCC_basic_nonbasic, real IDCC_nonbasic_basic, real IDCC_basic_nonbasic, real basic_noIDCC_IDCC, real basic_IDCC_noIDCC, int J) {
    ...
    Q[2,4] = noIDCC_nonbasic_basic;
    Q[4,2] = noIDCC_basic_nonbasic;
    Q[3,5] = IDCC_nonbasic_basic;
    Q[5,3] = IDCC_basic_nonbasic;
...
parameters {
  ...
  real<lower=0> noIDCC_nonbasic_basic;
  real<lower=0> noIDCC_basic_nonbasic;
  real<lower=0> IDCC_nonbasic_basic;
  real<lower=0> IDCC_basic_nonbasic;
  real<lower=0> basic_noIDCC_IDCC;
  real<lower=0> basic_IDCC_noIDCC;
}
transformed parameters {
  matrix[J,J] Q = fill_matrix(absent_nonbasic, nonbasic_absent, nonbasic_noIDCC_IDCC, nonbasic_IDCC_noIDCC, noIDCC_nonbasic_basic, noIDCC_basic_nonbasic, IDCC_nonbasic_basic, IDCC_basic_nonbasic, basic_noIDCC_IDCC, basic_IDCC_noIDCC, J);
...
model {
  ...
  noIDCC_nonbasic_basic ~ gamma(1,1);
  noIDCC_basic_nonbasic ~ gamma(1,1);
  IDCC_nonbasic_basic ~ gamma(1,1);
  IDCC_basic_nonbasic ~ gamma(1,1);
